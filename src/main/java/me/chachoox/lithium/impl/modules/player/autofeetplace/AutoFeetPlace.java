...
public class AutoFeetPlace extends BlockPlaceModule {
    ...
    public AutoFeetPlace() {
        ...
        this.offerListeners(new ListenerMotion(this), new ListenerRender(this), new ListenerBlockChange(this),
                new ListenerMutliBlockChange(this), new ListenerSound(this));
        this.offerProperties(jumpDisable);
    }
    ...
    private BlockPos getPlayerPos() {
        double decimalPoint = mc.player.posY - Math.floor(mc.player.posY); // u need this to place on echests
